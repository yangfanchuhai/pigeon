...
public class InvokeJsonServlet extends ServiceServlet {
	...
	private Object proxyInvoke(String serviceName, String methodName, String[] types, String[] values, int timeout)
		...
		referenceBean.setUrl(serviceName);
		referenceBean.setInterfaceName(service.getServiceInterface().getName());
		referenceBean.setVip("console:" + service.getServerConfig().getActualPort());
